...
Getting at variables inside lists/dataframes/tibbles
``` {r list_df_tibble_subsetting} 
e <- list(a = a, b= b, c = c, d = d) #make a named list
# single brackets returns a list with that element in it
# can reference by location
e[1]
# or name
e["a"]
...
#dolla dolla bills y'all (same thing)
e$c

#same for dataframes and tibbles
mtcars[1]
mtcars[[1]]
